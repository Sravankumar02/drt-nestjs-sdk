<a href="https://www.npmjs.com/package/@sravankumar02/sdk-nestjs-monitoring" target="_blank"><img src="https://img.shields.io/npm/v/@sravankumar02/sdk-nestjs-monitoring.svg" alt="NPM Version" /></a>
...
```
npm install @sravankumar02/sdk-nestjs-monitoring
```
...
```typescript
import { CpuProfiler } from '@sravankumar02/sdk-nestjs-monitoring';
...
```typescript
import { MetricsService, RequestCpuTimeInterceptor, LoggingInterceptor } from '@sravankumar02/sdk-nestjs-monitoring';
