<a href="https://www.npmjs.com/package/@sravankumar02/sdk-nestjs-monitoring" target="_blank"><img src="https://img.shields.io/npm/v/@sravankumar02/sdk-nestjs-cache.svg" alt="NPM Version" /></a>
...
```
npm install @sravankumar02/sdk-nestjs-cache
```
...
- [Redis Cache](#redis-cache) - Caching system based on [Redis](https://www.npmjs.com/package/@sravankumar02/sdk-nestjs-redis)
...
import { InMemoryCacheService } from '@sravankumar02/sdk-nestjs-cache';
...
```typescript
import { Injectable } from '@nestjs/common';
import { RedisCacheService } from '@sravankumar02/sdk-nestjs-cache';
