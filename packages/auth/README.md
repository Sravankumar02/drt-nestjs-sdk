<a href="https://www.npmjs.com/package/@sravankumar02/sdk-nestjs-auth" target="_blank"><img src="https://img.shields.io/npm/v/@sravankumar02/sdk-nestjs-auth.svg" alt="NPM Version" /></a>
...
```
npm install @sravankumar02/sdk-nestjs-auth
```
...
The second one, needs to be an instance of a [Caching service](https://www.npmjs.com/package/@sravankumar02/sdk-nestjs-cache)
...
```typescript
import { NativeAuthGuard } from "@sravankumar02/sdk-nestjs-auth";
...
```typescript
import { NativeAuthGuard, NativeAuthAdminGuard } from "@sravankumar02/sdk-nestjs-auth";
...
```typescript
import { JwtAuthenticateGuard } from "@sravankumar02/sdk-nestjs-auth";
...
```typescript
import { JwtAuthenticateGuard, JwtAdminGuard } from "@sravankumar02/sdk-nestjs-auth";
...
```typescript
import { NativeAuthGuard, NativeAuth } from "@sravankumar02/sdk-nestjs-auth";
